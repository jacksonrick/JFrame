...
public class UserController extends BaseController {
    ...
    public ModelAndView exportUserExcel(User condition) {
        ...
        model.put("list", userService.findUserForView(condition));
        model.put("header", new String[]{"nickname", "email", "phone", "create_time", "realname", "idcard", "address", "birthday"});
        model.put("headerVal", new String[]{"昵称", "邮箱", "手机号", "注册时间", "真实姓名", "身份证号码", "住址", "生日"});
        model.put("ename", "用户列表" + DateUtil.getCurrentTime(2));
