...
<script type="text/javascript">
    ...
    $(function () {
        $(".btn-enable").click(function () {
            ...
            layerConfirm('确定要' + title + '该组吗', "/admin/system/roleEnable.do?roleId=" + $(this).attr('data-id'));
        });
