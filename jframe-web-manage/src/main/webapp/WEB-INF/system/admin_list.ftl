    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <div class="row">
                    <div class="col-sm-12">
                        <form action="/admin/system/adminList.do" method="post" class="form-inline" id="queryForm">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <#if v.adminFlag == 1>
                                <a class="btn btn-sm btn-circle btn-warning" title="编辑" href="/admin/system/adminDetail.do?adminId=${v.id }"
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a class="btn btn-sm btn-info" title="新增管理员" data-open="modal" data-width="800px" data-height="400px"
                           href="/admin/system/adminDetail.do"><i class="fa fa-plus"></i>新增管理员</a>
                    </div>
                    <div class="col-sm-8">
                        <div class="pagination-ul">
                        <@pagination form="queryForm" data=page> </@pagination>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(function () {
        $(".btn-enable").click(function () {
            ...
            layerConfirm('确定要' + title + '该管理员吗', "/admin/system/adminEnable.do?adminId=" + $(this).attr('data-id'));
        });
    });
</script>
</body>
