    ...
    <div class="ibox-content">
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                <button type="button" class="btn btn-primary btn-sm" data-open="modal" data-width="800px" data-height="500px" href="/admin/user/userDetail.do" id="btn-add">
                ...
                <button type="button" class="btn btn-warning btn-sm" data-open="modal" data-width="800px"
                        data-height="500px" href="/admin/user/userList.do?mode=1"><i class="fa fa-user"></i> 选择用户
                </button>
            </div>
        </div>
    ...
    $(function () {
        var columns = [
            ...
            {title: "是否冻结", data: "isDelete", render: CONSTANT.RENDER.BOOLEAN},
            {
                ...
                render: function (data, type, full, callback) {
                    // btn-edit btn-del
                    var btns = CONSTANT.BUTTON.EDIT("/admin/user/userDetail.do?userId=" + full.id);
                    if (full.isDelete) {
        ...
        tables = $table.DataTable($.extend(true, {}, CONSTANT.DEFAULT_OPTION, {
            ...
            ajax: function (data, callback, settings) {
                CONSTANT.AJAX("/admin/user/userListData.do", [[1, "u.id"], [2, "u.nickname"], [3, "u.phone"], [8, "u.id"], [9, "u.is_delete"]], data, callback, settings);
            },
        ...
        $("#export").click(function () {// 导出到Excel
            ...
            location.href = '/admin/user/exportUserExcel.do?' + formData;
        });
        ...
        $table.on("change", ":checkbox", function () {
            ...
            layerConfirm('确定要删除或启用该用户吗', "/admin/user/userEnable.do?userId=" + item.id, function () {
                reload();
            });
        });
