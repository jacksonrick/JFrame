...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab" data-id="/admin/home.do">控制台<i class="b-re fa fa-repeat"></i></a>
                </div>
            </nav>
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" data-id="/admin/home.do" src="/admin/home.do" frameborder="0" seamless></iframe>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(function () {
        $("#changePwd").click(function () {
            openLayerUrl('修改密码', "400px", "380px", "/admin/pwd.do", false);
        });

        $(".logout").click(function () {
            layer.confirm('确定退出吗', {btn: ['确定', '取消'], icon: 3}, function () {
                jumpUrl("/admin/logout.do");
            });
        });
    });
</script>
