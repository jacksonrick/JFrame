...
public class BaseController {
    ...
    protected User getUser(HttpServletRequest request) {
        Object object = WebUtils.getSessionAttribute(request, Constant.SESSION_USER);
        if (object != null) {
            return (User) object;
        } else {
            return null;
    ...
    public Object exceptionHandler(Exception exception, HttpServletRequest request, HttpServletResponse response) {
        LogManager.info("An exception happened in [" + request.getRequestURI() + "], See the log file.");
