    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        for (Annotation annotation : methodAnnotations) {
            if (annotation instanceof Token) {
                ...
                if (Constant.TOKEN_HEADER.equals(type)) {
                    ...
                    if (!need) {
                        ...
                        if (StringUtil.isBlank(token)) {
                            ...
                            System.out.println(Constant.TOKEN_HEADER + " token:" + token);
                            return dealToken(token);
                        }
                    }
                } else if (Constant.TOKEN_COOKIE.equals(type)) {
                    ...
                    if (!need) {
                        ...
                        if (StringUtil.isNotBlank(token)) {
                            System.out.println(Constant.TOKEN_COOKIE + " token:" + token);
                            return dealToken(token);
                        } else {
                            throw new UserException(expMsg);
                        }
