...
<title>PWD</title>
<style>
    *{padding: 0px;margin: 0px;}body{padding: 50px;}
    .passwd{position: relative;height: 32px;margin: 20px;}
    .passwd-num{position: absolute;top: 0px;left: 0px;width: 30px;height: 30px;border: solid 1px #ECECEC;
        font-size: 22px;vertical-align: middle;text-align: center;cursor: text;outline: none;}
    .pass1{left: 0px;border-right: none;}
    .pass2{left: 31px;border-right: none;}
    .pass3{left: 61px;border-right: none;}
    .pass4{left: 91px;border-right: none;}
    .pass5{left: 121px;border-right: none;}
    .pass6{left: 151px;}
    .passwd-num.active{-webkit-box-shadow: inset 0 0px 1px rgba(0,0,0,0.08), 0 0 6px rgba(55, 138, 204, 0.8);
        box-shadow: inset 0 0px 1px rgba(0,0,0,0.08), 0 0 6px rgba(55, 138, 204, 0.8);
        z-index: 999;border: solid 1px #66afe9;
    }
</style>
</head>
