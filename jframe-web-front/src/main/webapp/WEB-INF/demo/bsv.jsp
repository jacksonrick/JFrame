...
<base href="<%=basePath%>">
<meta charset="utf-8">
<title>bootstrapValidator表单验证器</title>
<link href="/static/common/css/bootstrap.min.css" rel="stylesheet">
<script type="text/javascript" src="/static/library/jquery/jquery-1.11.0.min.js"></script>
...
<body>
<div class="container">
	<form id="defaultForm" method="post" class="form-horizontal" action="qwe.do">
