...
<style>
    *{padding: 0px;margin: 0px;}
    .header{height: 30px;border-bottom: solid 1px #CCCCCC;}
    .cart-con{float: right;margin-right: 300px;width: 100px;height: 30px;background-color: #00C1B3;text-align: center;line-height: 30px;}
    .item{width: 200px;height: 300px;border: solid 1px #CCCCCC;position: relative;margin: 300px auto;}
    .item-img{width: 200px;height: 160px;}
    .item-add{position: absolute;right: 10px;bottom: 10px;width: 50px;height: 50px;}
</style>
</head>
...
<script>
    function moveBox(obj) {
        ...
        img2.animate({
            ...
            duration: 500
        },"slow").fadeTo(0, 0.1).hide(0,function(){img2.remove();});
