...
public class TrackerClient {
    ...
    protected ServerInfo[] getStorages(TrackerServer trackerServer,
        ...
        try {
            ...
            if ((pkgInfo.body.length - ProtoCommon.TRACKER_QUERY_STORAGE_FETCH_BODY_LEN) % (ProtoCommon
                    .FDFS_IPADDR_SIZE - 1) != 0) {
                throw new IOException("Invalid body length: " + pkgInfo.body.length);
            }
    ...
    public StructStorageStat[] listStorages(TrackerServer trackerServer,
        ...
        try {
            ...
            header = ProtoCommon.packHeader(ProtoCommon.TRACKER_PROTO_CMD_SERVER_LIST_STORAGE, ProtoCommon
                    .FDFS_GROUP_NAME_MAX_LEN + ipAddrLen, (byte) 0);
