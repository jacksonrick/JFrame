...
public class Monitor {
  		...
  		*/
            ...
            for (StructGroupStat groupStat : groupStats) {
                ...
                for (StructStorageStat storageStat : storageStats) {
                    ...
                    System.out.println("\t\tip_addr = " + storageStat.getIpAddr() + "  " + ProtoCommon
                    ...
                    System.out.println("\t\tup time = " + (storageStat.getUpTime().getTime() == 0 ? "" : df.format
                            (storageStat.getUpTime())));
    ...
    protected static String getSyncedDelayString(StructStorageStat[] storageStats, StructStorageStat
            currentStorageStat) {
        long maxLastSourceUpdate = 0;
        for (StructStorageStat storageStat : storageStats) {
            if (storageStat != currentStorageStat && storageStat.getLastSourceUpdate().getTime() >
                    maxLastSourceUpdate) {
