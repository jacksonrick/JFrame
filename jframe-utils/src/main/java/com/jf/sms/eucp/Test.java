...
public class Test {
    ...
    //序列号密码
    public static String password="636268";
     ...
     */
    public static void testRegistEx() throws RemoteException {
    ...
    public static void testSendSMS() {
        try {
            int i= SingletonClient.getClient().sendSMS(new String[] {"17730215423"}, "【萝卜投】您此次验证码为：123456","",5);//带扩展码
